...
# Allow all origins for development (includes file:// protocol)
...
# Uncomment below for Redis when Redis server is running
# CHANNEL_LAYERS = {
#     'default': {
...
# Media storage configuration based on DEBUG setting
if DEBUG:
