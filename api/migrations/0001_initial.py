...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "group",
                    models.CharField(
                        help_text="Group/category of the translation (e.g., 'common', 'menu', 'error')",
                        max_length=100,
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
        ...
        migrations.AddIndex(
            model_name="language",
            index=models.Index(fields=["code"], name="languages_code_da77c1_idx"),
        ),
        migrations.AddField(
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=["-date"], name="analytics_d_date_38e7cc_idx"),
        ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=["key"], name="translation_key_6d38e9_idx"),
        ),
        migrations.AddIndex(
            model_name="translation",
            index=models.Index(fields=["group"], name="translation_group_d5a8d2_idx"),
        ),
