...
const AllProducts = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
          ...
          <h1 className="text-3xl font-bold text-secondary-800 mb-2">สินค้าทั้งหมด</h1>
          <p className="text-secondary-600">เลือกสั่งอาหารที่คุณชื่นชอบจากร้านต่างๆ ({totalProducts} รายการ)</p>
        </div>
      ...
      {products.length > 0 ? (
            ...
            {products.map((product) => (
              ...
              >
                <div className="relative h-48 bg-gray-200">
                  ...
                  <div className={'w-full h-full flex items-center justify-center ' + ((product.image_display_url || product.image) ? 'hidden' : '')}>
                    ...
                    if (restaurant?.status === 'closed') {
                      return (
                        <div className="absolute inset-0 bg-black bg-opacity-60 flex items-center justify-center">
                          <div className="text-center">
                            <span className="text-white font-semibold text-lg block">ปิดทำการ</span>
                            <span className="text-white/80 text-sm">{restaurant.restaurant_name}</span>
                          </div>
                        </div>
                      );
                      ...
                      return (
                        <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
                          <span className="text-white font-semibold">ไม่พร้อมจำหน่าย</span>
                        </div>
                      );
                    }
                    return null;
                ...
                <div className="p-4">
                  ...
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-xs text-secondary-500">
                      {product.restaurant_name || product.restaurant?.restaurant_name || product.restaurant?.name || 'ร้านอาหาร'}
                    </span>
                  </div>
                  ...
                  {(() => {
                    ...
                    return (
                      <>
                        ...
                        {/* ปุ่มดูร้านนี้ */}
                        <Link
                          to={`/restaurants/${product.restaurant_id || product.restaurant?.restaurant_id || product.restaurant?.id || product.restaurant}`}
                        ...
                        {!isRestaurantClosed && !isProductUnavailable && (
                          <button
                            onClick={() => {
                              ...
                              const result = addItem(productData, restaurantData);
        ...
        <div className="text-center py-12">
          ...
          <p className="text-secondary-500 mb-6">
            ลองเปลี่ยนคำค้นหาหรือตัวกรองดูสิ
          </p>
          <button
            onClick={() => {
              setSelectedCategory('');
